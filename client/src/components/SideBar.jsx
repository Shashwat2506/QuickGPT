...
const SideBar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30 border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute left-0 z-10 ${!isMenuOpen && 'max-md:-translate-x-full'}`}>
      ...
      alt="" className="w-full max-w-48"  />
       ...
       <button className='flex justify-center items-center w-full py-2 mt-10
        ...
        gap-2 p-3 mt-4 border border-gray-400 dark:border-white/20 rounded-md'>
       ...
       <div className='flex-1 overflow-y-scroll mt-3 text-sm space-y-3'>
        ...
        <p>Community Images</p>
            ...
            {/* Credit Purchases option Images */}
